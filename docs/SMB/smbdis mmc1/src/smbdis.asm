...
;MMC1 port by setz (@splixel on twitter - joseph.stevens.pgh@gmail.com)

;Now it assembles with cc65.
;Mapper changed to MMC1, some routines shuffled to fit in new ones
;Expanded to 4 PRG banks
;SRAM enabled
;SwapPRGBank - lda <bank> jsr SwapPRGBank
;SwapCHRBank0 - lda <bank> jsr SwapPRGBank
;SwapCHRBank1 - lda <bank> jsr SwapPRGBank

;build.sh was made for linux, should be easy enough to point that to your own cl65 though
;I hear on windows, "copy /b file+file2 rom.nes" works like cat, but I don't have windows to test
...
;MMC1 code taken from https://wiki.nesdev.com/w/index.php/Programming_MMC1
;init
InitMMC1:
			cld
...
SwapCHRBank1:
			...
			jsr SwapPRGBank
			pla
			jsr SwapCHRBank1_bank1
			rts

ImposeGravity:
			lda #$01
			jsr SwapPRGBank
			jsr ImposeGravity_bank1
			lda #$00
			jsr SwapPRGBank
			rts
